...
export default function Login() {
  ...
  return (
    <div className="font-google bg-gray-100 min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md p-8 rounded-2xl shadow-xl">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold">SLUBT</h1>
        ...
        <form className="space-y-5" onSubmit={signIn}>
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-slate-700 rounded-lg placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
          <div>
            <label
